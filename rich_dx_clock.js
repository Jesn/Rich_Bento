...
function checkStatusUrl() {
    return {
        url: "https://wx.ah.189.cn/wxws/clock/checkStatus",
        raw_url: "https://wx.ah.189.cn/wxws/clock/checkStatus",
        headers: {
            "Host": "wx.ah.189.cn",
            "Accept": "*/*",
...
// 支付50今币打卡请求参数
function checkClockUrl() {
    return {
        "url": "https://wx.ah.189.cn/wxws/clock/checkClock",
        "raw_url": "https://wx.ah.189.cn/wxws/clock/checkClock",
        "method": "post",
        "headers": {
            "Host": "wx.ah.189.cn",
            "Accept": "*/*",
        ...
        "body": `openid=${$.openid}&joinStatus=1&channel=`
    }
}
        ...
        $.post(checkClockUrl(), (err, resp, data) => {
            try {
                if (err) {
                    ...
                    data = JSON.parse(data);
                    console.log(data);
                    allMessage += `${$.index}个账号，今日已打卡,${JSON.stringify(data)}`
                }
            } catch (e) {
                $.logErr(e)
            }
